...
void TicTacToeUI::handle_ai_move() {
    ...
    if (ai_turn && !game.terminal() && game.player() != user) {
        ...
        // This is a blocking call, for a more responsive UI,
        // you might consider a separate thread or more advanced timer usage.
        // For XP compatibility and simplicity, Sleep is acceptable for short delays.
